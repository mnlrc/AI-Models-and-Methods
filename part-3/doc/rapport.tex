...
En d'autres termes, à chaque itération, la différence/variation entre les valeurs des états précédents et les nouvelles valeurs est calculée. Si celle-ci est inférieure du seuil $\delta$ donné, l'algorithme s'arrête. \\
...
Nous nous rendons très vite compte que la valeurs des états les plus éloignés de l'état initial en $(0, 6)$ (en haut à gauche) convergent plus rapidement que ceux plus proches de l'état d'origine.
