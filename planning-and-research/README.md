...
Core AI domain focused on exploring possible states to reach a goal. BFS, DFS, and A* are standard techniques.
- **Pathfinding and Navigation**: 
Used to find optimal or feasible paths in graphs or maps. A* is especially common due to heuristics.
- **Planning**: 
Computes sequences of actions from an initial state to a goal. Search algorithms explore action trees.
- **Game AI**: 
Explores game states to decide moves. Often combined with adversarial search.
- **Robotics**: 
Used for motion planning and decision making. Search helps robots navigate and act safely.
- **Automated Reasoning**: 
Searches through logical states or proofs. DFS and BFS are commonly used in inference systems.
